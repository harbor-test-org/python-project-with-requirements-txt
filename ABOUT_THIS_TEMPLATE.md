...
├── python_project_with_requirements_txt             # The main python package for the project
...
e.g: `cat python_project_with_requirements_txt/VERSION` will get the project version without harming
